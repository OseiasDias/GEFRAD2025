...
export default function ListaUtilizadores() {
    ...
    return (
        <>
                ...
                <div className="row mb-4 ">
                    <div className="col-12">
                        ...
                        <div className="d-flex justify-content-between mt-5">
                            ...
                            <h4 className="text-white mb-4">Lista de Administrador</h4>
            ...
            <Modal show={show} scrollable onHide={() => setShow(false)} size='xl'>
                            ...
                            <Row className="g-4">
                                ...
                                <Col md={8}>
                                    <Card className="shadow">
                                        <Card.Header className="bg-black text-white">
                                            <h5><FaUser className="me-2" /> Informações do Administrador</h5>
                                        </Card.Header>
                                        <Card.Body>
                                            <Row>
                                                <Col md={6}>
                                                    <p><strong>Nº Administrador: </strong><b>ADM00{mostrarOuNao(dados.id)}</b></p>
